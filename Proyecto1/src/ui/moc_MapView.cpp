/****************************************************************************
** Meta object code from reading C++ file 'MapView.hpp'
**
...
#include <memory>
#include "../../include/ui/MapView.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MapView.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 11), // "slotClicked"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9) // "slotIndex"

    },
    "MapView\0slotClicked\0\0slotIndex"
};
...
void MapView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MapView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapView::slotClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MapView::slotClicked(int _t1)
{
